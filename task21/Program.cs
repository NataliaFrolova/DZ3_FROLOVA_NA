...
namespace Seminar3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            static void DistanceBetweenPoints(int x1, int x2, int y1, int y2, int z1, int z2)
            {
                double distanceBetweenPoints = Math.Sqrt(Math.Pow(x1 - x2, 2) + Math.Pow(y1 - y2, 2) + Math.Pow(z1 - z2, 2));
